 ...
 */
@Listeners({com.meipian.appium.utils.AssertionListener.class})
public class BaseAppium {
    ...
    //app路径
    public static String appPath = System.getProperty("user.dir") + "/src/main/resources/app/meipian_4.0.2_official.apk";//

    //public static String appPath = System.getProperty("user.dir") + "/src/main/resources/app/meipian_test.apk";//meipian_4.0.2_official.apk

    //包名
    public static String appPackage = "com.lanjingren.ivwen";
    ...
    //要启动的Activity
    public static String appActivity = appPackage + ".ui.splash.SplashActivity";
    ...
    private static int SWIPE_DEFAULT_PERCENT = 10;    //默认滑动比例
